...
const { createTripPlan, addStopToTrip, uploadTicketPhoto, sendPushReminder, getTripPlanByBooking, updateTripPlan, deleteStop, getUserTripPlans, getTripPlanById } = require('../controllers/timetableController');
